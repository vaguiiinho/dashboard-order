...
export function CadastroTipoAtividadeForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Cadastro de Tipo de Atividade</h1>
        <p className="text-gray-600">Crie tipos de atividade vinculados a um setor</p>
      </div>
